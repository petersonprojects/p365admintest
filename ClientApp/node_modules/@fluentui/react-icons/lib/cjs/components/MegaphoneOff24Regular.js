...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M20.5 6.26v11.06l1.32 1.31c.11-.27.18-.57.18-.9V6.27a2.25 2.25 0 00-2.9-2.15L10 6.8l1.2 1.21 8.34-2.48a.75.75 0 01.96.72z", fill: primaryFill }));
};
const MegaphoneOff24Regular = wrapIcon_1.default(rawSvg({}), 'MegaphoneOff24Regular');
exports.default = MegaphoneOff24Regular;
