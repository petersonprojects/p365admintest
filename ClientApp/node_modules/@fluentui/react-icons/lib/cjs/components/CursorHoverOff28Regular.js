...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 28, height: 28, viewBox: "0 0 28 28", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M9.68 6.5L8.18 5h15.07A2.75 2.75 0 0126 7.75v11.5c0 .97-.5 1.82-1.26 2.31l-1.12-1.12c.51-.16.88-.63.88-1.19V7.75c0-.69-.56-1.25-1.25-1.25H9.68z", fill: primaryFill }));
};
const CursorHoverOff28Regular = wrapIcon_1.default(rawSvg({}), 'CursorHoverOff28Regular');
exports.default = CursorHoverOff28Regular;
