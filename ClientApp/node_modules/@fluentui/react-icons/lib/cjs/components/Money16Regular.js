...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 16, height: 16, viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M9 7a2 2 0 11-4 0 2 2 0 014 0zM8 7a1 1 0 10-2 0 1 1 0 002 0z", fill: primaryFill }),
        ...
        React.createElement("path", { d: "M4.5 13a1.5 1.5 0 01-1.43-1.04c.14.03.28.04.43.04h8.25C12.99 12 14 11 14 9.75V5.09c.58.2 1 .76 1 1.41v3.25c0 1.8-1.46 3.25-3.25 3.25H4.5z", fill: primaryFill }));
};
const Money16Regular = wrapIcon_1.default(rawSvg({}), 'Money16Regular');
exports.default = Money16Regular;
