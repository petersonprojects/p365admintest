...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 48, height: 48, viewBox: "0 0 48 48", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M26.37 19.87a1.25 1.25 0 101.76 1.76L41.5 8.27v10.48a1.25 1.25 0 102.5 0V5.25C44 4.56 43.44 4 42.75 4h-13.5a1.25 1.25 0 100 2.5h10.48L26.37 19.87z", fill: primaryFill }));
};
const CallOutbound48Regular = wrapIcon_1.default(rawSvg({}), 'CallOutbound48Regular');
exports.default = CallOutbound48Regular;
