...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 48, height: 48, viewBox: "0 0 48 48", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M43.63 6.13a1.25 1.25 0 10-1.76-1.76L28.5 17.73V7.25a1.25 1.25 0 00-2.5 0v13.5c0 .69.56 1.25 1.25 1.25h13.5a1.25 1.25 0 000-2.5H30.27L43.63 6.13z", fill: primaryFill }));
};
const CallInbound48Regular = wrapIcon_1.default(rawSvg({}), 'CallInbound48Regular');
exports.default = CallInbound48Regular;
