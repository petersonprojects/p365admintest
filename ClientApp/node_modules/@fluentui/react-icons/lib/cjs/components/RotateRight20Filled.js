...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M16.6 9c.22 0 .4.17.4.38v6.87c0 .41-.36.75-.8.75H3.4a.4.4 0 01-.35-.19.37.37 0 01.15-.51l13.2-7.25a.41.41 0 01.2-.05z", fill: primaryFill }));
};
const RotateRight20Filled = wrapIcon_1.default(rawSvg({}), 'RotateRight20Filled');
exports.default = RotateRight20Filled;
