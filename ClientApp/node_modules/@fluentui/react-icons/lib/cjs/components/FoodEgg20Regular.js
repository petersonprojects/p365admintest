...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M10.06 9.58a.5.5 0 10.14-1c-.94-.12-1.78.6-1.78 1.64a.5.5 0 001 0c0-.46.32-.68.64-.64z", fill: primaryFill }),
        React.createElement("path", { d: "M10.4 14.96a4.5 4.5 0 100-8.99 4.5 4.5 0 000 9zm0-1a3.5 3.5 0 110-6.99 3.5 3.5 0 010 7z", fill: primaryFill }),
...
const FoodEgg20Regular = wrapIcon_1.default(rawSvg({}), 'FoodEgg20Regular');
exports.default = FoodEgg20Regular;
