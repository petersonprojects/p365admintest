...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M15.25 11h-1.07l6.3 6.3A10 10 0 006.7 3.52l5.98 5.98h2.67a.75.75 0 010 1.5h-.1z", fill: primaryFill }));
};
const ChatOff24Filled = wrapIcon_1.default(rawSvg({}), 'ChatOff24Filled');
exports.default = ChatOff24Filled;
