...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M7.18 4l1.5 1.5h3.3l.01.17a2.5 2.5 0 001.97 2.28l.52 3.35 1.8 1.8-.82-5.3A2.5 2.5 0 1012.5 4h-5.3zm6.58 2.2a1 1 0 01.61-1.69h.27l.08.02.15.05.1.06v-.01a1 1 0 01.3 1.5l-.08.08-.1.1-.1.06-.09.04-.12.05-.17.04h-.25l-.08-.02-.09-.02-.1-.04-.1-.05-.08-.05-.12-.1-.03-.02z", fill: primaryFill }),
        React.createElement("path", { d: "M20.25 17.07l1.16 1.16a6.5 6.5 0 00-4.74-9.12l.25 1.6a5 5 0 013.33 6.36z", fill: primaryFill }));
};
const CropInterimOff24Regular = wrapIcon_1.default(rawSvg({}), 'CropInterimOff24Regular');
exports.default = CropInterimOff24Regular;
