...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M6 2c.32 0 .6.2.7.5L8.97 9a.75.75 0 11-1.42.5l-.34-1H4.8l-.34 1A.75.75 0 013.04 9L5.3 2.5c.1-.3.4-.5.71-.5zm-.68 5h1.36L6 5.04 5.32 7z", fill: primaryFill }),
...
const TextSortAscending20Filled = wrapIcon_1.default(rawSvg({}), 'TextSortAscending20Filled');
exports.default = TextSortAscending20Filled;
