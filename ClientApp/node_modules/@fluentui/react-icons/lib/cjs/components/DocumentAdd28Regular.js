...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 28, height: 28, viewBox: "0 0 28 28", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M14 20.5a6.5 6.5 0 11-13 0 6.5 6.5 0 0113 0zm-6-4a.5.5 0 00-1 0V20H3.5a.5.5 0 000 1H7v3.5a.5.5 0 101 0V21h3.5a.5.5 0 100-1H8v-3.5z", fill: primaryFill }));
};
const DocumentAdd28Regular = wrapIcon_1.default(rawSvg({}), 'DocumentAdd28Regular');
exports.default = DocumentAdd28Regular;
