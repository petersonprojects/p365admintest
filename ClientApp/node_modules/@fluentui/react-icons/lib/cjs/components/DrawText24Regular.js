...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M10.96 3c.31 0 .59.2.7.5l3.58 9.76-1.17 1.18-.47-1.27H8l-1.3 3.35a.75.75 0 01-1.4-.54l1.48-3.83v-.01l3.47-8.67c.12-.29.4-.47.71-.47zm-.04 2.85l-2.33 5.82h4.46l-2.13-5.82z", fill: primaryFill }),
...
const DrawText24Regular = wrapIcon_1.default(rawSvg({}), 'DrawText24Regular');
exports.default = DrawText24Regular;
