...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M15.54 19l-.3 1.26a2.25 2.25 0 01-2.01 1.73l-.17.01h-2.12c-.99 0-1.85-.65-2.14-1.58l-.05-.16L8.46 19h7.08z", fill: primaryFill }),
...
const LightbulbFilament24Filled = wrapIcon_1.default(rawSvg({}), 'LightbulbFilament24Filled');
exports.default = LightbulbFilament24Filled;
