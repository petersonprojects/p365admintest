...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 48, height: 48, viewBox: "0 0 48 48", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M29.25 4C28.56 4 28 4.56 28 5.25v17.5a1.25 1.25 0 102.5 0V16.5h5.25a6.25 6.25 0 000-12.5h-6.5zm6.5 10H30.5V6.5h5.25a3.75 3.75 0 010 7.5z", fill: primaryFill }));
};
const CallPark48Regular = wrapIcon_1.default(rawSvg({}), 'CallPark48Regular');
exports.default = CallPark48Regular;
