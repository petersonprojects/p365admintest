...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M20 2.75a.75.75 0 00-1.43-.3 2.38 2.38 0 01-.07.13c-.05.1-.13.23-.24.38-.22.32-.52.66-.9.9a.75.75 0 00.79 1.28l.35-.25v2.36a.75.75 0 001.5 0v-4.5z", fill: primaryFill }),
        React.createElement("path", { d: "M14 18.75a.75.75 0 00-.75-.75h-9a.75.75 0 000 1.5h9c.41 0 .75-.34.75-.75z", fill: primaryFill }),
        React.createElement("path", { d: "M14 12.24a.75.75 0 00-.75-.75h-9a.75.75 0 100 1.5h9c.41 0 .75-.33.75-.75z", fill: primaryFill }),
        React.createElement("path", { d: "M14 5.75a.75.75 0 00-.75-.75h-9a.75.75 0 000 1.5h9c.41 0 .75-.34.75-.75z", fill: primaryFill }),
        React.createElement("path", { d: "M19.15 10.52c-.3-.05-.68.07-.87.26a.75.75 0 11-1.06-1.06 2.57 2.57 0 012.2-.68c.39.07.8.26 1.1.6A2 2 0 0121 11c0 .62-.27 1.08-.6 1.42-.28.28-.64.51-.91.69l-.08.05c-.2.13-.36.24-.48.34h1.32a.75.75 0 010 1.5h-2.5a.75.75 0 01-.75-.75c0-1.31.98-1.95 1.58-2.34l.06-.04c.31-.2.53-.34.68-.5.14-.14.18-.24.18-.37 0-.22-.06-.32-.1-.36a.42.42 0 00-.25-.12z", fill: primaryFill }),
...
const TextNumberListRtl24Regular = wrapIcon_1.default(rawSvg({}), 'TextNumberListRtl24Regular');
exports.default = TextNumberListRtl24Regular;
