...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M2.47 12.25a5.16 5.16 0 119.42-4.2l1.22 2.75 1.67 1.62c.38.37.27 1-.22 1.22l-9.73 4.33a.75.75 0 01-1.05-.65L3.68 15l-1.21-2.75z", fill: primaryFill }),
        React.createElement("path", { d: "M8.83 17.34a1.49 1.49 0 002.68-1.2l-2.68 1.2z", fill: primaryFill }),
...
const AlertUrgent20Filled = wrapIcon_1.default(rawSvg({}), 'AlertUrgent20Filled');
exports.default = AlertUrgent20Filled;
