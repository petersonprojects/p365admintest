...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M14.5 6v5.32l1.43 1.43c.05-.24.07-.5.07-.75V6a4 4 0 00-7.86-1.04L9.5 6.32V6a2.5 2.5 0 015 0z", fill: primaryFill }),
        React.createElement("path", { d: "M17.2 14.01l1.14 1.15c.42-.88.66-1.87.66-2.91v-.6a.75.75 0 00-1.5.1v.72a5.23 5.23 0 01-.3 1.54z", fill: primaryFill }));
};
const MicOff24Regular = wrapIcon_1.default(rawSvg({}), 'MicOff24Regular');
exports.default = MicOff24Regular;
