...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M11.5 12.25c0-.41.34-.75.75-.75a.75.75 0 000-1.5C11.01 10 10 11 10 12.25a.75.75 0 001.5 0z", fill: primaryFill }),
        React.createElement("path", { d: "M7 12.5a5.5 5.5 0 1111 0 5.5 5.5 0 01-11 0zm5.5-4a4 4 0 100 8 4 4 0 000-8z", fill: primaryFill }),
...
const FoodEgg24Regular = wrapIcon_1.default(rawSvg({}), 'FoodEgg24Regular');
exports.default = FoodEgg24Regular;
