...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M7.18 4l1.5 1.5h3.3l.01.17a2.5 2.5 0 001.97 2.28l.52 3.35 1.8 1.8-.82-5.3A2.5 2.5 0 1012.49 4h-5.3z", fill: primaryFill }),
        React.createElement("path", { d: "M20.25 17.07l1.16 1.16a6.5 6.5 0 00-4.74-9.12l.25 1.6a5 5 0 013.33 6.36z", fill: primaryFill }));
};
const CropInterimOff24Filled = wrapIcon_1.default(rawSvg({}), 'CropInterimOff24Filled');
exports.default = CropInterimOff24Filled;
