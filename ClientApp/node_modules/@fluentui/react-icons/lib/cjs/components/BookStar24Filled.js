...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M11.6 9.53c-.1.2-.29.34-.51.37l-1.45.21 1.05 1.02c.16.16.23.39.2.6l-.26 1.45 1.3-.68c.2-.1.44-.1.64 0l1.3.68-.25-1.44a.68.68 0 01.2-.6l1.04-1.03-1.45-.21a.68.68 0 01-.51-.37l-.65-1.32-.65 1.32z", fill: primaryFill }),
...
const BookStar24Filled = wrapIcon_1.default(rawSvg({}), 'BookStar24Filled');
exports.default = BookStar24Filled;
