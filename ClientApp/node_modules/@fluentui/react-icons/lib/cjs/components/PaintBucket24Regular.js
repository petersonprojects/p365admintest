...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M19.52 13.6a.87.87 0 00-1.54 0l-2 3.77a3.15 3.15 0 105.55 0l-2-3.77zm-2.23 4.47l1.46-2.73 1.46 2.73a1.65 1.65 0 11-2.92 0z", fill: primaryFill }));
};
const PaintBucket24Regular = wrapIcon_1.default(rawSvg({}), 'PaintBucket24Regular');
exports.default = PaintBucket24Regular;
