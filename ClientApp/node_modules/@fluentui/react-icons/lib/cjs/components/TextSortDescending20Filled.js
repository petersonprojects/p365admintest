...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M3.25 2.75c0-.41.34-.75.75-.75h4a.75.75 0 01.6 1.2L5.48 7.5H8A.75.75 0 018 9H4a.75.75 0 01-.6-1.2l3.13-4.3H4a.75.75 0 01-.75-.75z", fill: primaryFill }),
...
const TextSortDescending20Filled = wrapIcon_1.default(rawSvg({}), 'TextSortDescending20Filled');
exports.default = TextSortDescending20Filled;
