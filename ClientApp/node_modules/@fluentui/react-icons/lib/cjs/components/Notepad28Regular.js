...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 28, height: 28, viewBox: "0 0 28 28", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M8 10.25c0-.41.34-.75.75-.75h10a.75.75 0 010 1.5h-10a.75.75 0 01-.75-.75z", fill: primaryFill }),
        React.createElement("path", { d: "M8 14.75c0-.41.34-.75.75-.75h10a.75.75 0 010 1.5h-10a.75.75 0 01-.75-.75z", fill: primaryFill }),
        React.createElement("path", { d: "M8.75 18.5a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-4.5z", fill: primaryFill }),
...
const Notepad28Regular = wrapIcon_1.default(rawSvg({}), 'Notepad28Regular');
exports.default = Notepad28Regular;
