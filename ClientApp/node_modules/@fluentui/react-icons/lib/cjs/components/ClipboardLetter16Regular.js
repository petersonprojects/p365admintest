...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 16, height: 16, viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M11.95 7.3a.5.5 0 00-.92 0l-2.11 4.95a.5.5 0 00-.05.1l-.83 1.96a.5.5 0 10.92.4L9.68 13h3.63l.73 1.7a.5.5 0 00.91-.4l-.83-1.94a.5.5 0 00-.05-.1L11.95 7.3zm.93 4.7H10.1l1.38-3.23L12.88 12z", fill: primaryFill }));
};
const ClipboardLetter16Regular = wrapIcon_1.default(rawSvg({}), 'ClipboardLetter16Regular');
exports.default = ClipboardLetter16Regular;
