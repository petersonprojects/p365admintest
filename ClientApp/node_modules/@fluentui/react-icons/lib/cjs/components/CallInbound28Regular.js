...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 28, height: 28, viewBox: "0 0 28 28", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M25.78 3.28a.75.75 0 00-1.06-1.06l-8.22 8.22V4.25a.75.75 0 00-1.5 0v8c0 .41.34.75.75.75h8a.75.75 0 000-1.5h-6.19l8.22-8.22z", fill: primaryFill }),
...
const CallInbound28Regular = wrapIcon_1.default(rawSvg({}), 'CallInbound28Regular');
exports.default = CallInbound28Regular;
