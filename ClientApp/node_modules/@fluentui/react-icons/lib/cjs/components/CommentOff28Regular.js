...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 28, height: 28, viewBox: "0 0 28 28", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M6.18 3l1.5 1.5h14.57c1.24 0 2.25 1 2.25 2.25v10.5c0 1.1-.8 2.03-1.85 2.22l1.18 1.18a3.75 3.75 0 002.17-3.4V6.75A3.75 3.75 0 0022.25 3H6.18z", fill: primaryFill }));
};
const CommentOff28Regular = wrapIcon_1.default(rawSvg({}), 'CommentOff28Regular');
exports.default = CommentOff28Regular;
