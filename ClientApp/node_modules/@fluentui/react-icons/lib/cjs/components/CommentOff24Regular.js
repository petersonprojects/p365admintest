...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M20.5 14.75c0 .7-.4 1.3-1 1.58l1.1 1.1a3.25 3.25 0 001.4-2.68v-8.5C22 4.45 20.54 3 18.75 3H6.18l1.5 1.5h11.07c.97 0 1.75.78 1.75 1.75v8.5z", fill: primaryFill }));
};
const CommentOff24Regular = wrapIcon_1.default(rawSvg({}), 'CommentOff24Regular');
exports.default = CommentOff24Regular;
