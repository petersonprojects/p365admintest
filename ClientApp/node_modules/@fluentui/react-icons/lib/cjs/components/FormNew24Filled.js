...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M8.25 10a.75.75 0 100 1.5.75.75 0 000-1.5z", fill: primaryFill }),
        React.createElement("path", { d: "M7.5 16.25a.75.75 0 111.5 0 .75.75 0 01-1.5 0z", fill: primaryFill }),
...
const FormNew24Filled = wrapIcon_1.default(rawSvg({}), 'FormNew24Filled');
exports.default = FormNew24Filled;
