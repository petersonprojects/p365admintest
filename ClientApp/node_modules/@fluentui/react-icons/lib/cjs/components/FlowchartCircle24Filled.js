...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M2 12a10 10 0 1120 0 10 10 0 01-20 0zm4.5-4.75v2.5c0 .41.34.75.75.75h.5v2.69l-1.78 1.78c-.3.3-.3.77 0 1.06l2 2c.3.3.77.3 1.06 0l1.78-1.78h2.69v.5c0 .41.34.75.75.75h2.5c.41 0 .75-.34.75-.75v-2.5a.75.75 0 00-.75-.75h-2.5a.75.75 0 00-.75.75v.5h-2.69l-1.56-1.56V10.5h.5c.41 0 .75-.34.75-.75v-2.5a.75.75 0 00-.75-.75h-2.5a.75.75 0 00-.75.75z", fill: primaryFill }));
};
const FlowchartCircle24Filled = wrapIcon_1.default(rawSvg({}), 'FlowchartCircle24Filled');
exports.default = FlowchartCircle24Filled;
