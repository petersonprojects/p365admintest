...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M12.5 6c-.3 0-.58.18-.7.47l-3.24 8a.75.75 0 101.38.56l.83-2.03h3.46l.83 2.03a.75.75 0 001.38-.56l-3.25-8A.75.75 0 0012.5 6zm-1.12 5.5l1.12-2.76 1.12 2.76h-2.24z", fill: primaryFill }),
...
const BookLetter24Regular = wrapIcon_1.default(rawSvg({}), 'BookLetter24Regular');
exports.default = BookLetter24Regular;
