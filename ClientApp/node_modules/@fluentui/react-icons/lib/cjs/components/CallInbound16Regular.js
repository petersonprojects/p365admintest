...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 16, height: 16, viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M13.85 2.15c.2.2.2.5 0 .7L10.71 6h1.8a.5.5 0 010 1H9.5a.5.5 0 01-.5-.5v-3a.5.5 0 011 0v1.8l3.15-3.15c.2-.2.5-.2.7 0z", fill: primaryFill }),
...
const CallInbound16Regular = wrapIcon_1.default(rawSvg({}), 'CallInbound16Regular');
exports.default = CallInbound16Regular;
