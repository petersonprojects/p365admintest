...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M17.85 2.85a.5.5 0 10-.7-.7L12 7.29V3.5a.5.5 0 00-1 0v5c0 .28.22.5.5.5h5a.5.5 0 000-1h-3.8l5.15-5.15z", fill: primaryFill }));
};
const CallInbound20Regular = wrapIcon_1.default(rawSvg({}), 'CallInbound20Regular');
exports.default = CallInbound20Regular;
