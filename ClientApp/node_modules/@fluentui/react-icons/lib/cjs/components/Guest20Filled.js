...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M10 7a2 2 0 100 4 2 2 0 000-4z", fill: primaryFill }),
        React.createElement("path", { d: "M7.72 12c-.61 0-1.31.41-1.33 1.2-.01.51.1 1.24.66 1.83.56.6 1.5.97 2.95.97 1.45 0 2.39-.37 2.95-.97.57-.6.67-1.32.66-1.83-.02-.79-.72-1.2-1.33-1.2H7.72z", fill: primaryFill }),
...
const Guest20Filled = wrapIcon_1.default(rawSvg({}), 'Guest20Filled');
exports.default = Guest20Filled;
