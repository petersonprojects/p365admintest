...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 28, height: 28, viewBox: "0 0 28 28", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M17.5 25.06L22.56 20h-4.31a.75.75 0 00-.75.75v4.31z", fill: primaryFill }));
};
const Notepad28Filled = wrapIcon_1.default(rawSvg({}), 'Notepad28Filled');
exports.default = Notepad28Filled;
