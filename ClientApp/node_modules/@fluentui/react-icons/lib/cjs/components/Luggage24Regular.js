...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M7 10.25c0-.41.34-.75.75-.75h8.5a.75.75 0 010 1.5h-8.5a.75.75 0 01-.75-.75z", fill: primaryFill }),
...
const Luggage24Regular = wrapIcon_1.default(rawSvg({}), 'Luggage24Regular');
exports.default = Luggage24Regular;
