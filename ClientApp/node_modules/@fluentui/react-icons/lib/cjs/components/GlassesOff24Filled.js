...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M13.3 10.12l7.3 7.3a3.25 3.25 0 001.4-2.67v-3.5c0-.53-.18-1.02-.49-1.4a.75.75 0 00-.12-.18l-3.64-3.95-.14-.13C17.2 5.21 16.66 5 16.1 5h-.94a.75.75 0 00.1 1.5h.94c.18.03.34.11.45.24L18.73 9h-3.48c-.83 0-1.56.45-1.95 1.12z", fill: primaryFill }));
};
const GlassesOff24Filled = wrapIcon_1.default(rawSvg({}), 'GlassesOff24Filled');
exports.default = GlassesOff24Filled;
