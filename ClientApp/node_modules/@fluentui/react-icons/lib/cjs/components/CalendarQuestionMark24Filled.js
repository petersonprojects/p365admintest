...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M21 6.25C21 4.45 19.54 3 17.75 3H6.25A3.25 3.25 0 003 6.25V7h18v-.75z", fill: primaryFill }),
        React.createElement("path", { d: "M21 12.02V8.5H3v9.25C3 19.55 4.46 21 6.25 21h5.77A6.5 6.5 0 0121 12.02z", fill: primaryFill }),
...
const CalendarQuestionMark24Filled = wrapIcon_1.default(rawSvg({}), 'CalendarQuestionMark24Filled');
exports.default = CalendarQuestionMark24Filled;
