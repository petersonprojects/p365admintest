...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M15.22 18.78c.3.3.77.3 1.06 0l1.27-1.27v4.74a.75.75 0 001.5 0v-4.64l1.17 1.17a.75.75 0 101.06-1.06l-2.5-2.5a.75.75 0 00-1.06 0l-2.5 2.5c-.3.3-.3.77 0 1.06z", fill: primaryFill }));
};
const PaintBrushArrowUp24Regular = wrapIcon_1.default(rawSvg({}), 'PaintBrushArrowUp24Regular');
exports.default = PaintBrushArrowUp24Regular;
