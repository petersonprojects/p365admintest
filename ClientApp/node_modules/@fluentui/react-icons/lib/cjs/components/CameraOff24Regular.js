...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M11.24 8.06L12.8 9.6a3 3 0 012.1 2.11l1.55 1.55a4.5 4.5 0 00-5.2-5.2z", fill: primaryFill }),
        React.createElement("path", { d: "M20.5 8.25v9.07l1.36 1.36c.1-.3.14-.6.14-.93v-9.5C22 6.45 20.54 5 18.75 5h-2.07l-.82-1.39a2.25 2.25 0 00-1.94-1.1h-3.8c-.78 0-1.5.4-1.91 1.07l-.56.9 1.1 1.08.73-1.2.07-.09a.75.75 0 01.57-.27h3.8c.27 0 .52.14.65.37l1.03 1.76c.14.23.38.37.65.37h2.5c.97 0 1.75.78 1.75 1.75z", fill: primaryFill }));
};
const CameraOff24Regular = wrapIcon_1.default(rawSvg({}), 'CameraOff24Regular');
exports.default = CameraOff24Regular;
