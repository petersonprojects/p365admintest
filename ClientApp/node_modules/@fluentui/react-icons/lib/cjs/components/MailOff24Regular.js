...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M20.5 7.68L14.18 11l1.11 1.11 5.21-2.74v7.52l-.07.36 1.13 1.13c.28-.48.44-1.04.44-1.63V7.07A3.25 3.25 0 0018.74 4H7.18l1.5 1.5H18.9c.9.08 1.61.83 1.61 1.75v.43z", fill: primaryFill }));
};
const MailOff24Regular = wrapIcon_1.default(rawSvg({}), 'MailOff24Regular');
exports.default = MailOff24Regular;
