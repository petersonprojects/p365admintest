...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M20.5 15.5a1 1 0 01-.83.99l1.14 1.14A2.5 2.5 0 0022 15.5v-9A2.5 2.5 0 0019.5 4H7.18l1.5 1.5H19.5a1 1 0 011 1v9z", fill: primaryFill }));
};
const CursorHoverOff24Regular = wrapIcon_1.default(rawSvg({}), 'CursorHoverOff24Regular');
exports.default = CursorHoverOff24Regular;
