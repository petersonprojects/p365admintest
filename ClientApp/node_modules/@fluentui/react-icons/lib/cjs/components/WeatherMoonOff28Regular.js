...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 28, height: 28, viewBox: "0 0 28 28", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M13.87 10.7l1.22 1.2c.95-2.94.73-5.96.27-8.23a10.5 10.5 0 017.16 15.67l1.1 1.1a12 12 0 00-9.16-18.4.75.75 0 00-.8.93c.52 2.05.91 4.92.21 7.72z", fill: primaryFill }));
};
const WeatherMoonOff28Regular = wrapIcon_1.default(rawSvg({}), 'WeatherMoonOff28Regular');
exports.default = WeatherMoonOff28Regular;
