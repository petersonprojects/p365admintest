...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M6 2c.2 0 .39.13.47.32l2.75 7a.5.5 0 01-.94.36L7.62 8H4.38l-.66 1.68a.5.5 0 01-.94-.36l2.75-7A.5.5 0 016 2zM4.77 7h2.46L6 3.87 4.77 7z", fill: primaryFill }),
...
const TextSortAscending20Regular = wrapIcon_1.default(rawSvg({}), 'TextSortAscending20Regular');
exports.default = TextSortAscending20Regular;
