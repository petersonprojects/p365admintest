...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 16, height: 16, viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M10.7 1.04a.5.5 0 00-.4.92l.28.15a7.21 7.21 0 012.49 2.48c1.02 1.7.95 3.52.93 3.86v.05a.5.5 0 001 0v-.02a7.87 7.87 0 00-.06-1.43 7.8 7.8 0 00-4.24-6z", fill: primaryFill }),
        React.createElement("path", { d: "M10.8 3.6a.5.5 0 10-.57.82 3.53 3.53 0 011.54 2.83.5.5 0 001 0v-.06a3.35 3.35 0 00-.06-.61A4.6 4.6 0 0011.31 4c-.28-.26-.52-.41-.52-.41z", fill: primaryFill }),
...
const AlertUrgent16Regular = wrapIcon_1.default(rawSvg({}), 'AlertUrgent16Regular');
exports.default = AlertUrgent16Regular;
