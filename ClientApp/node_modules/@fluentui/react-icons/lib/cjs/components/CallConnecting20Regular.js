...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M12.74 2.06a.5.5 0 10-.48.88l.38.21a8.5 8.5 0 014.33 6.59l.03.31a.5.5 0 101-.1l-.03-.31a9.5 9.5 0 00-4.84-7.36l-.39-.22z", fill: primaryFill }),
        React.createElement("path", { d: "M11.57 4.74a.5.5 0 01.69-.17l.12.08a6.5 6.5 0 013.07 4.5l.04.27a.5.5 0 11-.98.16l-.05-.26a5.5 5.5 0 00-2.6-3.82l-.12-.07a.5.5 0 01-.17-.69z", fill: primaryFill }));
};
const CallConnecting20Regular = wrapIcon_1.default(rawSvg({}), 'CallConnecting20Regular');
exports.default = CallConnecting20Regular;
