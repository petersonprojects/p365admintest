...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M3.5 2.5c0-.28.22-.5.5-.5h4a.5.5 0 01.42.78L4.93 8H8a.5.5 0 110 1H4a.5.5 0 01-.42-.78L7.07 3H4a.5.5 0 01-.5-.5z", fill: primaryFill }),
...
const TextSortDescending20Regular = wrapIcon_1.default(rawSvg({}), 'TextSortDescending20Regular');
exports.default = TextSortDescending20Regular;
