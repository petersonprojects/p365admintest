...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M17.5 4.5a.75.75 0 00-1.1-.66L4.9 10.1a.75.75 0 00.35 1.41h11.5c.41 0 .75-.34.75-.75V4.5zm-2 5h-5.33l5.33-2.9v2.9z", fill: primaryFill }),
...
const FlipVertical24Filled = wrapIcon_1.default(rawSvg({}), 'FlipVertical24Filled');
exports.default = FlipVertical24Filled;
