...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 28, height: 28, viewBox: "0 0 28 28", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M8.68 5.5l1.5 1.5h5.57c.97 0 1.75.78 1.75 1.75v5.57l1.5 1.5v-3.67l5-3.42v10.55l-4.9-3.36L24.18 21c.68.04 1.32-.49 1.32-1.25V8.25c0-1-1.12-1.6-1.95-1.03L19 10.32V8.76c0-1.8-1.45-3.25-3.25-3.25H8.68z", fill: primaryFill }));
};
const VideoOff28Regular = wrapIcon_1.default(rawSvg({}), 'VideoOff28Regular');
exports.default = VideoOff28Regular;
