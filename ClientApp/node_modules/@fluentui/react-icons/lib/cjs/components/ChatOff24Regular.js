...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M15.25 9.5h-2.57l1.5 1.5H15.35a.75.75 0 00-.1-1.5z", fill: primaryFill }),
        React.createElement("path", { d: "M20.5 12c0 1.53-.4 2.97-1.11 4.2l1.1 1.1A10 10 0 006.7 3.52l1.08 1.1A8.5 8.5 0 0120.5 12z", fill: primaryFill }));
};
const ChatOff24Regular = wrapIcon_1.default(rawSvg({}), 'ChatOff24Regular');
exports.default = ChatOff24Regular;
