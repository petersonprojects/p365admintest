...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M10 14.92a5.96 5.96 0 01-1.53-.48 23.1 23.1 0 000-2.35c.43.37.96.64 1.53.78V10.5c0-.83.67-1.5 1.5-1.5H15a4 4 0 00-6.58-3.05 5 5 0 00-.84-1.8l-.04-.05A6 6 0 0117 9h3.5c.83 0 1.5.67 1.5 1.5v9c0 .83-.67 1.5-1.5 1.5h-9a1.5 1.5 0 01-1.5-1.5v-4.58zm2 0V19h8v-8h-3.34A6 6 0 0112 14.92zM14.46 11H12v1.87A4 4 0 0014.46 11z", fill: primaryFill }));
};
const DesignIdeas24Filled = wrapIcon_1.default(rawSvg({}), 'DesignIdeas24Filled');
exports.default = DesignIdeas24Filled;
