...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M19.5 16.32V6.25c0-.97-.78-1.75-1.75-1.75H7.68L6.18 3h11.57C19.55 3 21 4.46 21 6.25v11.57l-1.5-1.5z", fill: primaryFill }),
        React.createElement("path", { d: "M15.25 6.5a2.25 2.25 0 110 4.5 2.25 2.25 0 010-4.5zm0 1.5a.75.75 0 100 1.5.75.75 0 000-1.5z", fill: primaryFill }));
};
const ImageOff24Regular = wrapIcon_1.default(rawSvg({}), 'ImageOff24Regular');
exports.default = ImageOff24Regular;
