...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M12 22a5.5 5.5 0 110-11 5.5 5.5 0 010 11zm0-1.5a4 4 0 003.3-6.25l-5.55 5.56c.64.44 1.42.69 2.25.69zm-3.3-1.75l5.55-5.56a4 4 0 00-5.56 5.56z", fill: primaryFill }));
};
const CallProhibited24Regular = wrapIcon_1.default(rawSvg({}), 'CallProhibited24Regular');
exports.default = CallProhibited24Regular;
