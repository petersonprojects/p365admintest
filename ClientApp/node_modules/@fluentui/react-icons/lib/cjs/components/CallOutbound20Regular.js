...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M11.15 8.15a.5.5 0 10.7.7L17 3.71V7.5a.5.5 0 101 0v-5a.5.5 0 00-.5-.5h-5a.5.5 0 100 1h3.8l-5.15 5.15z", fill: primaryFill }));
};
const CallOutbound20Regular = wrapIcon_1.default(rawSvg({}), 'CallOutbound20Regular');
exports.default = CallOutbound20Regular;
