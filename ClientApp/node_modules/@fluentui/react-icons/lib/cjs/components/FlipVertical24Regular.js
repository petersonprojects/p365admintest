...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        React.createElement("path", { d: "M17.13 3.86c.23.13.37.38.37.64v6.25c0 .41-.34.75-.75.75H5.25a.75.75 0 01-.36-1.4l11.5-6.26a.75.75 0 01.74.02zM8.2 10H16V5.76L8.2 10z", fill: primaryFill }),
...
const FlipVertical24Regular = wrapIcon_1.default(rawSvg({}), 'FlipVertical24Regular');
exports.default = FlipVertical24Regular;
