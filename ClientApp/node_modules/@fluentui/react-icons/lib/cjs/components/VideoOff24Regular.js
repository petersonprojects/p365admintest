...
const rawSvg = (iconProps) => {
    ...
    return React.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", className: className },
        ...
        React.createElement("path", { d: "M15.5 12.32V7.75c0-.97-.78-1.75-1.75-1.75H9.18l-1.5-1.5h6.07c1.8 0 3.25 1.46 3.25 3.25v.17l3.86-2.31a.75.75 0 011.14.64v11.5c0 .3-.17.54-.4.67l-1.1-1.1V7.57L17 9.67v4.15l-1.5-1.5z", fill: primaryFill }));
};
const VideoOff24Regular = wrapIcon_1.default(rawSvg({}), 'VideoOff24Regular');
exports.default = VideoOff24Regular;
